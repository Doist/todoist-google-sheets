...
export class TodoistService {
    ...
    private getTaskFromQuickAddResponse(responseData: SyncTask): Task {
        ...
        return {
            ...
            childOrder: responseData.child_order,
            ...
            addedAt: responseData.added_at,
            addedByUid: responseData.added_by_uid,
            parentId: responseData.parent_id ?? null,
            responsibleUid: responseData.responsible_uid ?? null,
            assignedByUid: responseData.assigned_by_uid ?? null,
            completedAt: responseData.completed_at,
            updatedAt: null,
            isDeleted: responseData.is_deleted,
            dayOrder: 0,
            isCollapsed: responseData.collapsed,
